...
def tik():
	titik = ['.   ','..  ','...... ']
	for o in titik:
		print("\r\033[1;91m[●] \033[1;92mPlease Waitt \033[1;97m"+o),;sys.stdout.flush();time.sleep(1)
...
def an():
    ...
    try:
        ...
        os.system('reset')
        print logo
        print 'Silahkankan Subscribe ke channell AN OFFICIALL !!'
        time.sleep(3)
        print 'Di Channell ini setiap hari nya akan men SHARE video'
        time.sleep(3)
        print 'tentang SCRIPT Dan TUTORIAL ANDROID'
        time.sleep(3)
        os.system('xdg-open https://bit.ly/2HgpB4c ')
        print 'User = an  dan   Pass = officiall'
        time.sleep(5)
...
def menu():
	...
	print "2]. Dump Id/email/hp"
	print "3]. Hack facebook account               "
	print "4]. Bot       "
	print "5]. Others           "
	print "6]. Show token           "
	print "7]. Delete trash          "
	print "8]. LogOut            "
	print "9]. Exit the programs          "
	pilih()
#-
def pilih():
